@props(['settings' => []])
<div x-data="contactSectionData(@js($settings))" class="w-full bg-blue-50 dark:bg-blue-950/40 border-y border-blue-100 dark:border-blue-900 py-12 px-6">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="flex gap-4 justify-center whitespace-nowrap">
...
<script>
function contactSectionData(initialSettings) {
    return {
