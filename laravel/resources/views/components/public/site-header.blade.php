<header class="sticky top-0 z-40 bg-white/95 backdrop-blur-sm border-b border-[#f1f1f4] px-4 sm:px-6 lg:px-10 py-3 sm:py-4 grid grid-cols-[auto,1fr,auto] items-center transition-all duration-200 gap-4"
        x-data="headerData()"
        x-init="init()">
    ...
    <!-- Middle column (reserved for future content) -->
