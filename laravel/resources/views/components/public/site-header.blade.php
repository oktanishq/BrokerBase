<header x-data="headerData()" class="sticky top-0 z-40" x-init="init()">
    <!-- Sticky container wrapping both header grid and mobile search -->
    <div class="sticky top-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-200">
        <!-- Desktop Header Grid -->
        ...
        <div class="sm:hidden border-t border-gray-200 dark:border-gray-700 py-3 px-4">
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
