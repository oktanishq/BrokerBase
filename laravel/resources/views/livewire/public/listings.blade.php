<section class="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 bg-gray-50/50 flex-1">
    <div class="max-w-[1280px] mx-auto">
        <h3 class="text-lg sm:text-xl font-bold text-[#121317] mb-4 sm:mb-6">{{ $title ?? 'Featured Properties' }}</h3>
