        ...
        <div class="flex flex-col md:flex-row">
            <div class="p-6 md:p-8 flex-1 flex flex-col justify-center">
                ...
                <div class="flex gap-4 pt-6">
                    <a href="tel:{{ $this->getCleanedPhoneNumber() }}" class="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-primary hover:bg-blue-800 text-white rounded-xl font-medium transition-shadow shadow-lg shadow-blue-500/30 whitespace-nowrap">
                        <span class="material-symbols-outlined">call</span>
                        Contact Us
                    </a>
                    <a href="{{ $this->getWhatsAppMessage() }}" target="_blank" rel="noopener noreferrer" class="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-[#25D366] hover:bg-green-600 text-white rounded-xl font-medium transition-shadow shadow-lg shadow-green-500/30 whitespace-nowrap">
