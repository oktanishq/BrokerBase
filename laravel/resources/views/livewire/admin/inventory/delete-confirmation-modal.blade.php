                ...
                >
                                    ...
                                    @if($propertyToDelete)
                                        <div class="bg-gray-50 rounded-lg p-3 border">
                                            <p class="text-sm font-semibold text-gray-900">
                                                <span>#{{ $propertyToDelete['id'] }}</span> -
                                                <span>{{ $propertyToDelete['title'] }}</span>
                                            </p>
                                            <p class="text-xs text-gray-500 mt-1">{{ $propertyToDelete['price'] }}</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="bg-gray-50 px-4 py-4 sm:px-8 sm:flex sm:flex-row-reverse gap-3">
                        ...
                        <button
                            ...
                            x-bind:disabled="$wire.isDeleting"
                        ...
                        >
                            <span x-show="!$wire.isDeleting">Delete Permanently</span>
