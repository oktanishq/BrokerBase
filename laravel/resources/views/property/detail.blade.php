...
<div class="max-w-7xl mx-auto">
    ...
    <!-- You May Also Like Section (Flipkart Style - Below Grid) -->
    <!-- Wrapped in padding to match the grid above -->
    <div class="px-4 sm:px-6 lg:px-10 w-full max-w-[100vw] overflow-hidden">
